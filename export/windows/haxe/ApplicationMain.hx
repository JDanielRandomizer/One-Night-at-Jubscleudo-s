...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("OneNightAtJubs", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("OneNightAtJubs", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "542";
		app.meta["company"] = "JDanielDeveloper";
		app.meta["file"] = "OneNightAtJubs";
		app.meta["name"] = "One Night at Jubscleudo's";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "One Night at Jubscleudo's",
			width: 1280,
			x: null,
			y: null,
		};
		...
		#elseif air
		app.window.title = "One Night at Jubscleudo's";
		#else
